...
\title{\vspace{-2cm} Processamento Digital de Sinais e Aplicações em Acústica\\ Tutorial 02 - Sinais e Sistemas}
...
\begin{document}
	...
	\input{PythonInicial.tex}
	
	\input{Sistemas.tex}
	
	\input{EnergiaEPotenciaDeSinais.tex}
	
	\input{CriarArquivosWav.tex}
