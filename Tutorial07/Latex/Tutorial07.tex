...
\begin{document}
	...
	\begin{equation}
		x(t) = \sum_{n=-\infty}^{+\infty} C_k \, e^{\,j \, 2\pi k f_0 t},
...
N = 25
	...
	\label{sec:tarefa_condicoes}
	 ...
	 Utilize como sinal de referência a onda dente-de-serra, cujos coeficientes de seno são dados por:
	...
	\begin{enumerate}
		...
		\item Usando as configurações iniciais acima, sintetize o sinal $x(t)$ no domínio do tempo somando $N = 25$ termos da Série de senos de Fourier (equação de síntese \eqref{eq:sintese_real} com $A_n = 0$):
		\begin{equation*}
