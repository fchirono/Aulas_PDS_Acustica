...
%	\end{itemize}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item Inferior: magnitude da FFT centrada em $f=0$ Hz, e réplicas espectrais em $\pm f_{s,d}$. Marque também as frequências $\pm f_1$ da onda senoidal com linhas verticais \\(Sugestão: use \tt{matplotlib.pyplot.vlines})
		\end{itemize}
