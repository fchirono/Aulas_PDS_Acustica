...
plt.plot(t_c, x_aliasing1, label="250 Hz")
plt.plot(t_d, x_aliasing1[::20], 'ro')
plt.legend()
plt.xlim([0, 0.025])
plt.ylabel("Amplitude")
plt.title("f1 = 250 Hz / fs = 1000 Hz")
...
plt.plot(t_c, x_aliasing2, label="450 Hz")
plt.plot(t_d, x_aliasing2[::20], 'ro')
plt.legend()
plt.xlim([0, 0.025])
plt.ylabel("Amplitude")
plt.title("f1 = 450 Hz / fs = 1000 Hz")
...
plt.plot(t_c, x_aliasing3, label="750 Hz")
plt.plot(t_d, x_aliasing3[::20], 'ro')
plt.plot(t_c, np.cos(2*np.pi*250*t_c), ':', label="250 Hz")
plt.legend()
plt.xlim([0, 0.025])
plt.ylabel("Amplitude")
plt.xlabel("Tempo [s]")
plt.title("f1 = 750 Hz / fs = 1000 Hz")
